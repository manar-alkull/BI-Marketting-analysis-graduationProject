...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div id="log_activity1" class="dashboard_graph">
...
-->
        <div class="col-md-4 col-sm-12 col-xs-12">
            <div class="dashboard_graph x_panel">
                <div class="row x_title">
                    <div class="col-md-6">
                        <h3>{{ $counts['label_of_chart'] }}<small></small></h3>
                    </div>
                    <div class="col-md-6">
                        <div id="re rtrange" class="pull-right" style="background: #fff; padding: 5px 10px; border: 1px solid #ccc">
                            <i class="glyphicon glyphicon-calendar fa fa-calendar"></i>
                            <span>{{ \Carbon\Carbon::now()->addDays(-6)->format('F j, Y') }} - {{ \Carbon\Carbon::now()->format('F j, Y') }}</span> <b class="caret"></b>
                        </div>
                    </div>
                </div>
                <div class="x_content">
                    <div class="demo-container" style="height:250px">
                            <div id="chart_plot_09_time" class="demo-placeholder"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>console.log("logggggggggggggggggggggg");</script>
    <script scr="/assets/thirdparty/with.js"></script>
    <script></script>
    <!-- /page content -->
...
@section('scripts')
    @parent
    {{ Html::script(mix('assets/admin/js/withTime.js')) }}
    {{ Html::script(mix('/assets/admin/js/echarts.js')) }}
    {{ Html::script(mix('/assets/admin/js/world.js')) }}
    {{ Html::script(mix('/assets/admin/js/jquery.vmap.js')) }}
    {{ Html::script(mix('/assets/admin/js/jquery.vmap.world.js')) }}
    {{ Html::script(mix('/assets/admin/js/jquery.vmap.sampledata.js')) }}
    {{ Html::script(mix('assets/admin/js/dashboard-custom.js')) }}
    {{ Html::script(mix('assets/admin/js/with.js')) }}
@endsection
